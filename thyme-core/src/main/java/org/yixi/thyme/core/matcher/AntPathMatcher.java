 ...
 * <p>Some examples:<br>
 * <ul>
 * <li><code>com/t?st.jsp</code> - matches <code>com/rest.jsp</code> but also
 ...
 * <li><code>com/&#42;&#42;/rest.jsp</code> - matches all <code>rest.jsp</code>
 ...
 * <a href="http://www.springframework.org">Spring Framework</a> with modifications. We didn't
 * want to reinvent the wheel of great work they've done, but also didn't want to force every Shiro
 * user to depend on Spring</p>
 * <p>As per the Apache 2.0 license, the original copyright notice and all author and copyright
 * information have remained in tact.</p>
 *
 * @since 16.07.2003
 */
...
public class AntPathMatcher {
   ...
   * @param path the path String to rest
   ...
   * characters:<br> '*' means zero or more characters<br> '?' means one and only one character
   *
   ...
   * <p/>
   * <p> Copied from the Spring Framework while retaining all license, copyright and author
   * information.
   *
