 ...
 * the changes were proposed in comments in his blog: http://blog.locut.us/2008/01/12/a-decent-stand-alone-java-bloom-filter-implementation/
 *
...
public class BloomFilter<E> implements Serializable {
   ...
   * elements and the size of the Bloom filter. <br /><br /> The value returned by this method is
   * the <i>expected</i> rate of false positives, assuming the number of inserted elements equals
   * the number of expected elements. If the number of elements in the Bloom filter is less than the
  ...
  /**
   * Returns the value chosen for K.<br /> <br /> K is the optimal number of hash functions based on
   * the size of the Bloom filter and the expected number of inserted elements.
   *
   * @return optimal k.
   */
  public int getK() {
